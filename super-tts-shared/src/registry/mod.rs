...
pub struct SelectedAsset {
    ...
    #[serde(
        deserialize_with = "super_tts_registry_types::index::one_or_many_string",
        serialize_with = "super_tts_registry_types::index::one_or_many_string_ser"
    )]
...
pub use super_tts_registry_types::index::IndexStale;
