...
///
/// [`HttpError`]: super_tts_shared::daemon::http_client::HttpError
/// [`is_user_denied`]: super_tts_shared::daemon::widget_subscription::is_user_denied
pub(super) fn classify_daemon_error(
    err: super_tts_shared::daemon::http_client::HttpError,
) -> DaemonStatus {
    if super_tts_shared::daemon::widget_subscription::is_user_denied(&err) {
...
pub(super) fn widget_event_to_notification(
    evt: &super_tts_shared::daemon::http_client::WidgetEvent,
) -> Option<super_tts_shared::models::protocol::NotificationEvent> {
    ...
    Some(super_tts_shared::models::protocol::NotificationEvent {
...
mod widget_event_to_notification_tests {
    ...
    use super::*;
    use super_tts_shared::daemon::http_client::WidgetEvent;
