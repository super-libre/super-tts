...
mod model_status_tests {
    ...
    fn active_backend_missing_from_catalog_is_none() {
        let map = HashMap::new();
        assert_eq!(
            classify_model_status(Some("github.com/super-tts/openai"), &[], &map, "", "",),
            ModelStatus::None,
        );
    }
    ...
    fn unmet_requirement_is_blocked() {
        ...
        let map = HashMap::new();
        assert_eq!(
            classify_model_status(Some("github.com/super-tts/openai"), &backends, &map, "", "",),
            ModelStatus::Blocked,
        );
    }
    ...
    fn loaded_model_from_other_source_is_idle() {
        ...
        assert_eq!(
            classify_model_status(
                Some("github.com/super-tts/openai"),
                &backends,
                &map,
                "piper-mini-latest",
