...
//! About page view for the Super TTS application.
...
const APP_ICON: &[u8] =
    include_bytes!("../../../resources/icons/hicolor/scalable/apps/super-tts-app.svg");
...
pub fn page() -> Element<'static, Message> {
    ...
    let title = widget::text::title3("Super TTS");
