...
//! `super-tts-install`'s command line: the curl-bootstrap/interactive
...
pub fn parse_cli() -> Cli {
    let m = Command::new("super-tts-install")
        .about("Install or update Super TTS (daemon, CLI, app, COSMIC applet)")
